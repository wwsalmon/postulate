...
import {deserializeHTMLToDocumentFragment} from "@udecode/slate-plugins-html-serializer";
import {ELEMENT_CODE_BLOCK, ELEMENT_LINK, getSlatePluginType, someNode} from "@udecode/slate-plugins";
 ...
 */
export const createCustomDeserializeHTMLPlugin = getSlatePluginWithOverrides(
    withDeserializeHTML
);
